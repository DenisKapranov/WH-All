class WeatherControl {
    ...
    constructor() {
        ...
        this.countries = {
            ...
            london: "http://api.openweathermap.org/data/2.5/weather?id=2643743&appid=bf35cac91880cb98375230fb443a116f",
    ...
    setList(date) {
        ...
        outputStr += '<div class="visual" ><img src="' + src + ' " width="50" height="50"></div>';
        outputStr += '<div class="temp"> ' + degree + '<hr></div>';
